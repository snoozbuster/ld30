    ...
    public class CharacterCameraControlScheme : CameraControlScheme
    {
        ...
        public override void Update(float dt)
        {
            ...
            if (UseCameraSmoothing)
            {
                ...
                Vector3 goalPosition = bodyPosition + up * (Character.StanceManager.CurrentStance == Stance.Standing ? StandingCameraOffset : CrouchingCameraOffset) + Camera.Offset;
            ...
            {
                Camera.Position = Character.Body.Position + Camera.Offset;
            }
        }
    }
}
