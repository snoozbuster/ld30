    ...
    public class Loader : IEnumerable<float>
    {
        ...
        public IEnumerator<float> GetEnumerator()
        {
            ...
            GeneralCategory.Add(new Prop(content.Load<Model>("models/general/incline"), new Vector3(2, 2, 1), false, false, false, true, "Stairs", "NOW you're going places.",
                (p, s) => { BEPUutilities.Vector3[] v; int[] i; ModelDataExtractor.GetVerticesAndIndicesFromModel(content.Load<Model>("models/general/incline"), s, out v, out i); Entity e = new MobileMesh(v, i, BEPUutilities.AffineTransform.Identity, MobileMeshSolidity.Counterclockwise); e.Tag = e.Position; e.Position = p + new Vector3(1, 1, 0.5f); return e; }));
            yield return progress();
            GeneralCategory.Add(new Prop(content.Load<Model>("models/general/inclinecorner"), new Vector3(2, 2, 1), false, false, false, true, "Corner Stairs", "For those hard-to-reach spots.",
                (p, s) => { BEPUutilities.Vector3[] v; int[] i; ModelDataExtractor.GetVerticesAndIndicesFromModel(content.Load<Model>("models/general/inclinecorner"), s, out v, out i); Entity e = new MobileMesh(v, i, BEPUutilities.AffineTransform.Identity, MobileMeshSolidity.Solid); e.Tag = e.Position; e.Position = p + new Vector3(1, 1, 0.5f); return e; }));
            yield return progress();
            ...
            GeneralCategory.Add(new Prop(content.Load<Model>("models/general/pyramid"), new Vector3(2, 2, 1), false, false, false, true, "Pyramid", "I can't fathom what this would be useful for.",
                (p, s) => { BEPUutilities.Vector3[] v; int[] i; ModelDataExtractor.GetVerticesAndIndicesFromModel(content.Load<Model>("models/general/pyramid"), s, out v, out i); Entity e = new MobileMesh(v, i, BEPUutilities.AffineTransform.Identity, MobileMeshSolidity.Counterclockwise); e.Tag = e.Position; e.Position = p + new Vector3(1, 1, 0.5f); return e; }));
            yield return progress();
            ...
            InteriorCategory.Add(new Prop(content.Load<Model>("models/interior/chair"), new Vector3(1, 1, 2), false, false, false, true, "Chair", "A small chair.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f, 0.5f, 1) * s - Vector3.UnitZ * (2 - 1.5f) * 0.5f * s.Z, s.X * 0.9f, s.Y * 0.9f, s.Z * 1.5f)));
            yield return progress();
            InteriorCategory.Add(new Prop(content.Load<Model>("models/interior/crate"), new Vector3(1, 1, 1), false, false, false, true, "Crate", "What does it hold?",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f) * s - Vector3.UnitZ * (1 - 0.8f) * 0.5f * s.Z, s.X * 0.8f, s.Y * 0.8f, s.Z * 0.8f)));
            yield return progress();
            ...
            InteriorCategory.Add(new Prop(content.Load<Model>("models/interior/teapot"), new Vector3(1, 1, 1), false, false, false, true, "Teapot", "Short and stout.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f) * s - Vector3.UnitZ * (1 - 0.55f) * 0.5f * s.Z, s.X * 0.75f, s.Y * 0.4f, s.Z * 0.55f)));
            yield return progress();
            InteriorCategory.Add(new Prop(content.Load<Model>("models/interior/nightstand"), new Vector3(1, 1, 1), true, false, false, true, "Nightstand", "For keeping things in and on.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f, 0.5f, 1) * s * s.Z, s.X * 0.9f, s.Y * 0.85f, s.Z)));
            yield return progress();
            InteriorCategory.Add(new Prop(content.Load<Model>("models/interior/fireplace"), new Vector3(4, 2, 3), false, false, false, true, "Fireplace", "Glorious and warm.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(2, 1, 1.5f) * s - Vector3.UnitZ * (3 - 2.5f) * 0.5f * s.Z, s.X * 3.6f, s.Y * 1.7f, s.Z * 2.5f)));
            yield return progress();
            InteriorCategory.Add(new Prop(content.Load<Model>("models/interior/plate"), new Vector3(1, 1, 1), false, false, false, true, "Plate", "Have your potato and eat it too.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f) * s - Vector3.UnitZ * (1 - 0.15f) * 0.5f * s.Z, s.X, s.Y, s.Z * 0.15f)));
            yield return progress();
            ExteriorCategory.Add(new Prop(content.Load<Model>("models/exterior/rock"), new Vector3(2, 2, 1), false, false, false, true, "Rock", "Just an ordinary boulder.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(1, 1, 0.5f) * s - Vector3.UnitZ * (1 - 0.7f) * 0.5f * s.Z, s.X * 1.4f, s.Y * 1.3f, s.Z * 0.7f)));
            yield return progress();
            ...
            ExteriorCategory.Add(new Prop(content.Load<Model>("models/exterior/bush"), new Vector3(2, 2, 2), false, false, false, true, "Bush", "It is adamant that you refer to it as George.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(1, 1, 1) * s - Vector3.UnitZ * (1 - 1.7f) * 0.5f, s.X * 2 * s.Z, s.Y * 2, s.Z * 1.7f)));
            yield return progress();
            ExteriorCategory.Add(new Prop(content.Load<Model>("models/exterior/grass"), new Vector3(2, 2, 1), false, false, false, true, "Grass", "A small patch of grass.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(1, 1, 0.5f) * s - Vector3.UnitZ * (1 - 0.3f) * 0.5f, s.X * 2 * s.Z, s.Y * 2, s.Z * 0.3f)));
            yield return progress();
            ExteriorCategory.Add(new Prop(content.Load<Model>("models/exterior/plant"), new Vector3(1, 1, 1), false, false, false, true, "Plant", "A sprig of something.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f) * s, s.X * 0.6f, s.Y * 0.3f, s.Z)));
            yield return progress();
            ExteriorCategory.Add(new Prop(content.Load<Model>("models/exterior/barrel"), new Vector3(2, 2, 3), false, false, false, true, "Barrel", "A nice wooden barrel.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(1, 1, 1.5f) * s - Vector3.UnitZ * (3 - 2.5f) * 0.5f, s.X * 2, s.Y * 2 * s.Z, s.Z * 2.5f)));
            yield return progress();
            ExteriorCategory.Add(new Prop(content.Load<Model>("models/exterior/fence"), new Vector3(2, 1, 2), false, false, false, true, "Fence", "Keeps people out.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(1, 0.5f, 1) * s, s.X * 2, s.Y * 0.5f, s.Z * 2)));
            yield return progress();
            ExteriorCategory.Add(new Prop(content.Load<Model>("models/exterior/ironfence"), new Vector3(2, 1, 2), false, false, false, true, "Iron Fence", "Keeps STRONG people out.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(1, 0.5f, 1) * s, s.X * 2, s.Y * 0.3f, s.Z * 2)));
            yield return progress();
            ExteriorCategory.Add(new Prop(content.Load<Model>("models/exterior/mushroom"), new Vector3(2, 2, 3), false, false, false, true, "Mushroom", "It's huge!",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(1, 1, 1.5f) * s - Vector3.UnitZ * (3 - 2.9f) * 0.5f * s.Z, s.X * 2, s.Y * 2, s.Z * 2.9f)));
            yield return progress();
            ExteriorCategory.Add(new Prop(content.Load<Model>("models/exterior/pump"), new Vector3(1, 2, 2), false, false, false, true, "Pump", "Rusted shut.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f, 1, 1) * s, s.X * 0.5f, s.Y * 1.4f, s.Z * 2)));
            yield return progress();
            ...
            DecorationCategory.Add(new Prop(content.Load<Model>("models/decoration/checkerboard"), new Vector3(1, 1, 1), false, false, false, true, "Checkerboard", "You can also use it for chess.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f) * s - Vector3.UnitZ * (1 - 0.1f) * 0.5f * s.Z, s.X, s.Y, s.Z * 0.1f)));
            yield return progress();
            ...
            DecorationCategory.Add(new Prop(content.Load<Model>("models/decoration/gnome"), new Vector3(1, 1, 2), false, false, false, true, "Gnome", "Worth millions.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f, 0.5f, 1) * s - Vector3.UnitZ * (2 - 1.4f) * 0.5f * s.Z, s.X * 0.8f, s.Y * 0.3f, s.Z * 1.4f)));
            yield return progress();
            DecorationCategory.Add(new Prop(content.Load<Model>("models/decoration/potato"), new Vector3(1, 1, 1), false, false, false, true, "Potato", "Potatoes gonna potate. #LudumSpud #SpudumDare",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f) * s - Vector3.UnitZ * (1 - 0.25f) * 0.5f * s.Z, s.X * 0.5f, s.Y * 0.25f, s.Z * 0.25f)));
            yield return progress();
            ...
            DecorationCategory.Add(new Prop(content.Load<Model>("models/decoration/trafficcone"), new Vector3(1, 1, 2), false, false, false, true, "Traffic Cone", "You'll have no trouble with traffic now!",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f, 0.5f, 1) * s - Vector3.UnitZ * (2 - 1.4f) * 0.5f * s.Z, s.X, s.Y, s.Z * 1.4f)));
            yield return progress();
            StatueCategory.Add(new Prop(content.Load<Model>("models/statues/abduction"), new Vector3(1, 1, 2), false, false, false, true, "UFO Statue", "Moo.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f, 0.5f, 1) * s - Vector3.UnitZ * (2 - 1.45f) * 0.5f * s.Z, s.X * 0.9f, s.Y * 0.9f, s.Z * 1.45f)));
            yield return progress();
            StatueCategory.Add(new Prop(content.Load<Model>("models/statues/parabox"), new Vector3(1, 1, 2), false, false, false, true, "Rectangular Man", "He looks very at home.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f, 0.5f, 1) * s - Vector3.UnitZ * (2 - 1.7f) * 0.5f * s.Z, s.X * 0.9f, s.Y * 0.5f, s.Z * 1.7f)));
            yield return progress();
            StatueCategory.Add(new Prop(content.Load<Model>("models/statues/travesty"), new Vector3(1, 1, 2), false, false, false, true, "Flat Man", "Give him a sword and he'll be set!",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f, 0.5f, 1) * s - Vector3.UnitZ * (1 - 1.55f) * 0.5f * s.Z, s.X * 0.9f, s.Y * 0.9f, s.Z * 1.55f)));
            yield return progress();
            StatueCategory.Add(new Prop(content.Load<Model>("models/statues/wip"), new Vector3(1, 1, 1), false, false, false, true, "Anvil", "They say this particular anvil floats.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f) * s - Vector3.UnitZ * (1 - 0.5f) * 0.5f, s.X * 0.9f * s.Z, s.Y * 0.9f, s.Z * 0.5f)));
            yield return progress();
            ...
            StatueCategory.Add(new Prop(content.Load<Model>("models/statues/obelisk"), new Vector3(1, 1, 2), false, false, false, true, "Obelisk", "Mystical artifact. Possibly from another planet.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(0.5f, 0.5f, 1) * s - Vector3.UnitZ * (2 - 1.95f) * 0.5f * s.Z, s.X * 0.7f, s.Y * 0.7f, s.Z * 1.95f)));
            yield return progress();
            ...
            StatueCategory.Add(new Prop(content.Load<Model>("models/statues/kerath"), new Vector3(2, 2, 3), false, false, false, true, "Kerath's Arch", "Brought to you by the letter V.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(1, 1, 1.5f) * s - Vector3.UnitZ * (3 - 2.4f) * 0.5f * s.Z, s.X * 1.8f, s.Y * 1.8f, s.Z * 2.4f)));
            yield return progress();
            StatueCategory.Add(new Prop(content.Load<Model>("models/statues/lion"), new Vector3(2, 2, 1), false, false, false, true, "Lion", "I'm not lion, it's no sphinx.",
                (p, s) => new BEPUphysics.Entities.Prefabs.Box(p + new Vector3(1, 1, 0.5f) * s, s.X * 1.6f, s.Y * 2, s.Z)));
            yield return progress();
            #endregion
            ...
            bridge = new Prop(content.Load<Model>("models/bridge"), new Vector3(10, 2, 4), false, false, true, false, "Bridge", "You aren't supposed to see this.",
                (p, s) => { BEPUutilities.Vector3[] v; int[] i; ModelDataExtractor.GetVerticesAndIndicesFromModel(content.Load<Model>("models/bridge"), Vector3.One, out v, out i); Entity e = new MobileMesh(v, i, BEPUutilities.AffineTransform.Identity, MobileMeshSolidity.Solid); e.Position = p; return e; });
            yield return progress();
